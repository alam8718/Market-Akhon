...
function CartItem({item}) {
  ...
  return (
    <>
      <div className=" flex gap-x-4 py-2 lg:px-6 border border-gray-200 w-full font-light text-gray-500">
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="flex  h-[40px] gap-x-2 text-sm ">
              <div className="flex items-center felx-1 h-full border text-primary font-medium max-w-[100px]">
                {/* minus icons */}
                <div className="flex flex-1 h-full p-2 justify-center items-center cursor-pointer">
                  <IoMdRemove />
                </div>
